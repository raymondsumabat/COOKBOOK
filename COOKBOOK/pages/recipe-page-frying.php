...
<div class="wrapper">
 ...
 $name = mysqli_real_escape_string($con, $_GET['name']);
 $result = mysqli_query($con, "SELECT * FROM recipes WHERE recipeCat='Frying' AND recipeStatus='1' AND recipeName='$name'");
 ...
 ?>
  ...
  <?php
   ...
   if(isset($_POST['submit-rating'])) {
     ...
     echo 'window.location.href = "../pages/recipe-page-frying.php?name='.$namerecipe.'";';
     echo '</script>';
