...
<link rel="stylesheet" href="../css/design-frying.css"/>

 <div class="wrapper">
   <h1>&nbsp;&nbsp;FRYING RECIPES</h1>
 </div>

 <?php

 $result = mysqli_query($con, "SELECT * FROM recipes WHERE recipeCat='Frying' AND recipeStatus='1'");

 while ($row = mysqli_fetch_array($result)) {
   echo "<div class='child-page-listing'>
           <div class='grid-container'>
              <article class='recipe-listing'>
              <a href='recipe-page-frying.php?name=".$row['recipeName']."'>
